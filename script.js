        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            requiredFields.forEach(field => {
                ...
                if (!value) {
                    ...
                    formData[field.getAttribute('name')] = value;
                }
            });
...
function initZappyAccessibilityToolbar() {
    ...
    try {
        ...
        var pageLang = (htmlEl.getAttribute('lang') || 'el').toLowerCase().split('-')[0];
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '31f9ce61-cd45-4488-841e-ac0425131944',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '31f9ce61-cd45-4488-841e-ac0425131944';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '31f9ce61-cd45-4488-841e-ac0425131944';
